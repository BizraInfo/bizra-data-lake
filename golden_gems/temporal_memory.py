...
class TemporalMemoryHierarchy:
    ...
    def __init__(self):
        self.layers = {
            ...
            "L4_semantic": TemporalMemoryLayer(
                "semantic", gamma=0.9999, max_items=10000
            ),
...
def demo():
    ...
    print(
        f"Half-lives: L1={mem.layers['L1_perception'].half_life:.1f}, L2={mem.layers['L2_working'].half_life:.1f}"
    )
