...
class TaskManager:
    ...
    def submit_parallel(
        self, tasks: List[TaskCard], parent_task_id: Optional[str] = None
    ) -> List[str]:
        """
    ...
    async def execute(
        self, task: TaskCard, executor: Callable[[TaskCard], Awaitable[Any]]
    ) -> Any:
        """
...
class TaskDecomposer:
    ...
    def decompose(self, task: TaskCard, strategy: str = "parallel") -> List[TaskCard]:
        """
