...
try:
    ...
    from clear_framework import CLEARFramework, CLEARMetrics, MetricWeight  # type: ignore[import-not-found, no-redef]
    from ablation_engine import AblationEngine, AblationStudy, AblationType, ComponentCategory  # type: ignore[import-not-found, no-redef]
    from moe_router import MoERouter, ExpertTier, RoutingDecision  # type: ignore[import-not-found, no-redef]
    from leaderboard import LeaderboardManager, Benchmark, SubmissionConfig, SubmissionResult  # type: ignore[import-not-found, no-redef]
