...
- Keep authored probabilities/scores/hours unchanged for this snapshot.
- Treat this as an internal historical artifact, not a production benchmark page.
- Future dynamic telemetry version must ship as a separate artifact/milestone.
