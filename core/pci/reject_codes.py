...
def reject_schema(envelope_digest: str, timestamp: str, details: str) -> RejectionResponse:
...
def reject_replay(envelope_digest: str, timestamp: str, nonce: str) -> RejectionResponse:
