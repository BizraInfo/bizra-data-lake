...
impl Default for IhsanThreshold {
    fn default() -> Self {
        Self { minimum: IHSAN_THRESHOLD, target: 0.99 }
    }
}
...
pub enum Enforcement { Strict, Advisory, Monitoring }

#[derive(Clone, Debug, Serialize, Deserialize)]
pub enum Penalty { Reject, TrustPenalty(f64), Cooldown(u64), None }
...
impl Default for Constitution {
    fn default() -> Self {
        ...
        rules.insert("IHSAN_001".into(), Rule {
            id: "IHSAN_001".into(),
        ...
        rules.insert("SNR_001".into(), Rule {
            id: "SNR_001".into(),
        ...
        rules.insert("CRYPTO_001".into(), Rule {
            id: "CRYPTO_001".into(),
...
impl Constitution {
    pub fn check_ihsan(&self, score: f64) -> bool { score >= self.ihsan.minimum }
    pub fn check_snr(&self, snr: f64) -> bool { snr >= self.snr_threshold }
    pub fn get_rule(&self, id: &str) -> Option<&Rule> { self.rules.get(id) }
}
