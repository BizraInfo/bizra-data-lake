...
def test_pool_initialization():
    ...
    assert stats["MasterReasoner"] == 2, f"Expected 2 MasterReasoner, got {stats['MasterReasoner']}"

    assert "PoiVerifier" in stats, "PoiVerifier pool not initialized"
    assert stats["PoiVerifier"] == 1, f"Expected 1 PoiVerifier, got {stats['PoiVerifier']}"
