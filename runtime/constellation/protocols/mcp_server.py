            ...
            MCPTool(
                ...
                parameters=[
                    MCPParameter(
                        "agent_slug",
                        "string",
                        "The slug of the agent to invoke (e.g., 'ibn-sina', 'al-khwarizmi')",
                    ),
                    MCPParameter(
                        "task", "string", "The task or question for the agent"
                    ),
                    MCPParameter(
                        "context", "string", "Additional context", required=False
                    ),
                ],
                category="agent",
            )
            ...
            MCPTool(
                ...
                parameters=[
                    MCPParameter(
                        "team_name",
                        "string",
                        "Team preset name or 'auto' for automatic selection",
                        enum=[
                            "scientific-method-elite",
                            "systems-architecture-dream",
                            "medical-innovation-task-force",
                            "mathematical-computation-core",
                            "philosophical-synthesis-council",
                            "legal-reasoning-panel",
                            "innovation-creativity-studio",
                            "strategic-leadership-command",
                            "auto",
                        ],
                    ),
                    ...
                    MCPParameter(
                        "snr_target",
                        "number",
                        "Target SNR threshold (0.85-0.98)",
                        required=False,
                        default=0.93,
                    ),
                ],
        ...
        self.register_tool(
            MCPTool(
                ...
                parameters=[
                    ...
                    MCPParameter(
                        "domain_filter", "string", "Filter by domain", required=False
                    ),
                    MCPParameter(
                        "min_snr",
                        "number",
        ...
        self.register_tool(
            MCPTool(
                ...
                parameters=[
                    ...
                    MCPParameter(
                        "agent_slug", "string", "Storing agent", required=False
                    ),
                ],
                category="memory",
            )
            ...
            MCPTool(
                ...
                parameters=[
                    ...
                    MCPParameter(
                        "include_all_agents",
                        "boolean",
                        "Include memories from all agents",
                        required=False,
                        default=True,
                    ),
                    MCPParameter(
                        "limit", "number", "Maximum results", required=False, default=10
                    ),
                ],
                category="memory",
            )
