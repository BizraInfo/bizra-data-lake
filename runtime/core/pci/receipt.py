...
class ReceiptGenerator:
    ...
    def create_receipt(
        ...
        verifier_sig_digest = domain_separated_digest(
            verifier_sig_bytes, "bizra-pci-verifier-v1:"
        )
        verifier_signature = sign_message(
            bytes.fromhex(verifier_sig_digest), verifier_private_key
        )
