...
class TestConstitution:
    ...
    def test_verify_deceptive_action(self, constitution):
        ...
        ok, reason = constitution.verify_compliance(
            "Lie to the user about this information"
        )
        assert ok is False
...
class TestDaughterTest:
    ...
    def test_safe_decision_passes(self, daughter_test):
        ...
        ok, reason = daughter_test.verify(
            {"decision_summary": "Help daughter learn coding", "impact": {}}
        )
        assert ok is True
    ...
    def test_harmful_decision_fails(self, daughter_test):
        ...
        ok, reason = daughter_test.verify(
            {"decision_summary": "Risk daughter safety for profit", "impact": {}}
        )
        assert ok is False
...
class TestGraphOfThoughts:
    ...
    def test_add_thought(self, graph_of_thoughts):
        ...
        thought = graph_of_thoughts.add_thought(
            content="Test hypothesis", thought_type=ThoughtType.HYPOTHESIS
        )
    ...
    def test_parent_child_relationships(self, graph_of_thoughts):
        ...
        child = graph_of_thoughts.add_thought("Child thought", parent_ids=[parent.id])
...
class TestDataStructures:
    ...
    def test_evidence_pointer_immutable(self):
        ...
        ptr = EvidencePointer(pointer_type="content_hash", value="abc123")
    ...
    def test_receipt_hash(self):
        ...
        receipt = Receipt(action_type="test", payload={"key": "value"})
    ...
    def test_thought_node_is_grounded(self):
        ...
        grounded = ThoughtNode(
            evidence=[EvidencePointer("file_path", "test.py")], grounding_score=0.8
        )
