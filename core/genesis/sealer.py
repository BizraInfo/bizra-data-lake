...
class GenesisSeal:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "GenesisSeal":
        return cls(
            ...
            timestamp=data["timestamp"],
            attestations=[SealAttestation.from_dict(a) for a in data.get("attestations", [])],
...
class GenesisSealer:
    ...
    def seal_phase(
        ...
        content_hash = self._domain_hash(content_bytes, GENESIS_DOMAIN_PREFIX + f"phase{phase}:")
