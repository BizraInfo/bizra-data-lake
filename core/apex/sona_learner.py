...
class LearningConfig:
    ...
    def from_env(cls) -> "LearningConfig":
        ...
        return cls(
            ...
            state_path=os.getenv("SONA_STATE_PATH", "docs/evidence/apex/sona_state.json"),
        )
...
class SONALearner:
    ...
    def record_execution(self, record: ExecutionRecord) -> None:
        ...
        pattern.avg_latency_ms = (pattern.avg_latency_ms * (n - 1) + record.latency_ms) / n
    ...
    def evaluate_performance(self) -> PerformanceMetrics:
        ...
        self._metrics.avg_quality_score = np.mean(quality_scores) if quality_scores else 0.0
    ...
    def get_improvement_progress(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "patterns_elevated": sum(1 for p in self._tracked_patterns.values() if p.elevated),
        }
    ...
    def _save_state(self) -> None:
        ...
        try:
            ...
            state = {
                ...
                "patterns": {
                    h: p.to_dict() for h, p in self._tracked_patterns.items()
                },
    ...
    def _load_state(self) -> None:
        ...
        try:
            ...
            if "routing_weights" in data:
                self._routing_weights = RoutingWeights.from_dict(data["routing_weights"])
...
async def main():
    ...
    parser.add_argument("--progress", action="store_true", help="Show improvement progress")
