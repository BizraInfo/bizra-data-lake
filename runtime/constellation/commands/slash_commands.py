...
def _register_builtin_commands() -> None:
    ...
    registry.register(
        ...
        arguments=[
            CommandArgument(
                "agent_name", ArgumentType.AGENT, description="Agent slug to invoke"
            ),
            CommandArgument("task", ArgumentType.TEXT, description="Task to perform"),
        ],
    ...
    registry.register(
        ...
        arguments=[
            CommandArgument(
                "team_name", ArgumentType.TEAM, description="Team name to assemble"
            ),
            CommandArgument("task", ArgumentType.TEXT, description="Task for the team"),
        ],
    ...
    registry.register(
        ...
        arguments=[
            CommandArgument("query", ArgumentType.TEXT, description="Search query"),
        ],
    ...
    registry.register(
        ...
        category=CommandCategory.MEMORY,
        arguments=[
            CommandArgument("claim", ArgumentType.TEXT, description="Claim to verify"),
        ],
    ...
    registry.register(
        ...
        arguments=[
            CommandArgument(
                ...
                required=False,
                default="agents",
                choices=["agents", "teams", "triggers", "commands"],
