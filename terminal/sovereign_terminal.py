...
5. JARVIS persona — warm, competent, constitutionally grounded
...
class TerminalRenderer:
    ...
    def morning_briefing(self, identity: Optional[NodeIdentity], health: Optional[NodeHealth]):
        """Proactive morning briefing — JARVIS persona."""
        if self.json_mode:
            return
    ...
    def agents(self):
        ...
        if self.console:
            ...
            self.console.print(table)
            self.console.print("[dim]⚠️ Human → JARVIS → PAT → Pool → SAT (Boundary Model)[/]")
    ...
    def help_screen(self):
        ...
        if self.console:
            ...
            cmds = [
                ...
                ("briefing", "Morning briefing from JARVIS"),
