...
async def cmd_chat(args):
    ...
    from core.inference.multi_model_manager import ModelPurpose, get_multi_model_manager
...
def main():
    ...
    p_chat.add_argument(
        "--purpose",
        choices=["reasoning", "vision", "agentic", "general", "nano"],
        default="general",
    )
    ...
    p_reason.add_argument(
        "--show-thinking", action="store_true", help="Show chain-of-thought"
    )
