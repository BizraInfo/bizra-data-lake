...
class ValidationResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            ] if self.pat_gate_results else None,
    ...
    async def validate(
        ...
        try:
            ...
            if context.require_pat_enforcement and context.pat_request:
                ...
                if not pat_result.passed:
                    ...
                    for gate_result in pat_gate_results:
                        if not gate_result.passed and gate_result.gate_id != GateID.GATE_4_PRACTITIONER:
            ...
            return ValidationResult(
                ...
                pci_gate_results=pci_gate_results,
                pat_gate_results=pat_gate_results,
                snr_result=snr_result or EnforcementResult(
                    passed=False,
                    snr_score=0.0,
