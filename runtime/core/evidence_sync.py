                ...
                for line in f:
                    ...
                    if line:
                        try:
                            ...
                            logger.warning(
                                "Invalid JSON in receipt file %s: %s", receipt_file, e
                            )
    ...
    async def sync_lake_to_receipts(self) -> SyncResult:
        ...
        for attestation in attestations:
            ...
            if self.write_receipt(receipt):
                ...
                errors.append(
                    f"Failed to write receipt for {attestation.attestation_hash}"
                )
...
if __name__ == "__main__":
    ...
    async def test():
        ...
        print(
            f"PoI Ledger: {integrity['poi_ledger']['valid']}/{integrity['poi_ledger']['total']} valid"
        )
        print(
            f"Receipts: {integrity['receipts']['valid']}/{integrity['receipts']['total']} valid"
        )
